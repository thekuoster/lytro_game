    ...
    <?php if(have_posts()) : ?>
        <?php while(have_posts()) : the_post(); ?>
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <div class="entry-content">
                    <div class="entry-attachment">
                        ...
                        ?>
                        <a href="<?php echo esc_url($next_attachment_url); ?>" title="<?php the_title_attribute(); ?>" rel="attachment"><?php $attachment_size = apply_filters('priimo_attachment_size', PRIIMO_CONTENT_WIDTH); echo wp_get_attachment_image($post->ID, array($attachment_size, 1024)); ?></a>
            ...
            <div class="single-navigation">
                <span class="nav-previous"><?php previous_image_link(false, __('Previous' ,'priimo')); ?></span>
                <span class="nav-next"><?php next_image_link(false, __('Next' ,'priimo')); ?></span>
            </div>
